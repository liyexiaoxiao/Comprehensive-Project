...
def _find_music_file_path(filename):
...
def get_music_file(emotion):
    ...
    try:
        ...
        file_path = _find_music_file_path(filename)
    ...
    try:
        ...
        for directory in MUSIC_DIRS:
            ...
            for filename in os.listdir(directory):
                if filename.endswith('.mp3') and filename not in filenames:
...
def get_music_file_by_name(filename):
    ...
    try:
        ...
        search_paths = [
            *[os.path.join(directory, safe_name) for directory in MUSIC_DIRS],
